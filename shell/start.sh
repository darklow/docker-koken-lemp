...
sed -i -e"s/pm.max_children = 5/pm.max_children = $PHP_MAX/" /etc/php7.0/fpm/pool.d/www.conf
sed -i -e"s/pm.max_children = 5/pm.max_children = $PHP_MAX/" /etc/php7.0/fpm/pool.d/images.conf
